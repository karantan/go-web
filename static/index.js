...
var $author$project$Index$init = function (_v0) {
	return _Utils_Tuple2(
		{password: '', serverMessage: '', state: $author$project$Index$Init, username: ''},
...
var $author$project$Index$Response = function (message) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'username',
				$elm$json$Json$Encode$string(record.username)),
				_Utils_Tuple2(
				'password',
				$elm$json$Json$Encode$string(record.password))
			]));
};
			...
			default:
				...
				if (resp.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{password: '', serverMessage: serverResponse.message, state: $author$project$Index$Success, username: ''}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = resp.a;
					return _Utils_Tuple2(
...
var $author$project$Index$UpdatePassword = function (a) {
	return {$: 'UpdatePassword', a: a};
};
var $author$project$Index$UpdateUsername = function (a) {
...
var $author$project$Index$formDisabled = function (_v0) {
	...
	return ((username === '') || (password === '')) ? true : (A2(
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		$rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.username),
																		$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Index$UpdateUsername),
																		$rundis$elm_bootstrap$Bootstrap$Form$Input$placeholder('Joe')
																	]))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Form$group,
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		$rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.password),
																		$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Index$UpdatePassword),
																		$rundis$elm_bootstrap$Bootstrap$Form$Input$placeholder('secret123')
																	]))
															])),
														A2(
